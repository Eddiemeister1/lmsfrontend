...
export class PendingEnrollmentComponent implements OnInit {
  ...
  constructor(private studentCourseService: StudentCourseService, private courseService: CourseService, private groupsService: GroupsService, private studentService: StudentService, private emailer: EmailNotificationService, private route: ActivatedRoute) { }
