...
export class StudentCourseService {
  ...
  getStudentPoints(courseId, studentId) {
    return this.http.get(`${environment.apiURL}/student-courses/get-score/${courseId}/${studentId}`);
  }

  getTotalPossiblePoints(courseId) {
    return this.http.get(`${environment.apiURL}/student-courses/get-all-mod-score/${courseId}/`)
  }
}
